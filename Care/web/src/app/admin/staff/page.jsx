...
export default function StaffPage() {
  ...
  return (
    <div className="cx-wide">
      <PageBand eyebrow="Directory" title="Staff" lede="Your care team, their roles, and who is available now. Select a team member to view their work profile." action={<Link href="/admin/staff/new" className="cx-btn cx-btn-primary" style={{ textDecoration: "none" }}><UserPlus size={15} /> Add staff</Link>} />
      <div className="cx-page-rhythm">
        ...
        <div className="cx-toolbar">
          ...
          <span className="cx-results-count cx-tnum">{rows.length} team member{rows.length === 1 ? "" : "s"}</span>
        </div>
